...
abstract class BaseMVVMDataBindingFragment<V : ViewDataBinding, VM : BaseViewModel<out IBaseModel>> : BaseMVVMFragment<V, VM>() {
    ...
    final override fun createViewModel() : VM {
        ...
        // 通过反射，绑定 v 和 vm
        val bindingClz = com.arthur.commonlib.utils.ReflectUtils.getTargetTFromObj<Any>(this, BaseMVVMDataBindingFragment::class.java, ViewDataBinding::class.java)
        val vmClz = com.arthur.commonlib.utils.ReflectUtils.getTargetTFromObj<Any>(this, BaseMVVMDataBindingFragment::class.java, BaseViewModel::class.java)
