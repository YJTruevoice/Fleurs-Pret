...
abstract class BaseMVVMDataBindingActivity<V : ViewDataBinding, VM : BaseViewModel<out IBaseModel>> : BaseMVVMActivity<V, VM>() {
    ...
    override fun createViewModel() : VM{
        ...
        // 通过反射，绑定 v 和 vm
        val bindingClz = ReflectUtils.getTargetTFromObj<Any>(this, BaseMVVMDataBindingActivity::class.java, ViewDataBinding::class.java)
        val vmClz = ReflectUtils.getTargetTFromObj<Any>(this, BaseMVVMDataBindingActivity::class.java, BaseViewModel::class.java)
